    ...
    <script type="text/javascript">
        ...
        function connect() {
            ...
            if ('WebSocket' in window) {
                ws= new WebSocket("ws://localhost:8080/tw/webSocketServer");
            }else {
                ws = new SockJS("http://localhost:8080/tw/sockjs/webSocketServer");
            }
...
<div>
    <div id="connect-container">
        <input id="radio1" type="radio" name="group1" onclick="updateUrl('/tw/webSocketServer');">
            <label for="radio1">W3C WebSocket</label>
        <br>
        <input id="radio2" type="radio" name="group1" onclick="updateUrl('/tw/sockjs/webSocketServer');">
