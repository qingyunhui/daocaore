...
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	...
	<section class="content">
		<div class=" box box-success">
			<div class="box-body">     
				<form role="form" id="addForm" class="form-horizontal" action="${diaoyuPath}/sys/sysUser/doAdd.htm" method="post">
					<!-- form start -->
						...
						<table class="form-table form-table-2 form-table-info">
							<tbody>
								...
								<tr class="form-group-sm">
			                        ...
			                        <td>
			                        	<input class="form-control" id="userJob" name="userJob" value="${sysUserForm.userJob}" placeholder="职业" type="text">
			                        </td>
								</tr>
								<tr class="form-group-sm">
									<th>
...
<script type="text/javascript">
	...
	var objs=${dytld:getEnumJSON('cn.com.liangdian.diaoyu.enums.Sex')};
