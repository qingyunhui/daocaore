...
<body class="skin-blue sidebar-mini fixed skin-blue-light-frame">
	...
	<section class="content">
			...
			<div class="box-body">
				<form id="searchForm" method="post" >
					<div class="input">
						...
						<div class="textalign">手机号：</div>
	                    <div class="boxinput">
	                        <input type="text" class="textinput"  id="mobilephone" name="mobilephone"  placeholder="手机号" maxlength="85" />
	                    </div>
					</div>
				</form>
			</div>
		...
		<div class="btn-control-box">
			<button id="addBtn" type="button" class="btn btn-primary btn-sm navbar-right">新增</button>
			<button id="deletedBtn" type="button" class="btn btn-primary btn-sm navbar-right">删除</button>
